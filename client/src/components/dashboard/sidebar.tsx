      ...
      <Container fluid>
        ...
        >
          <h2 className="logo text-white">
            <span className="text-danger">Spare</span> Parts
          </h2>
        </Link>
        ...
        <div className="collapse navbar-collapse" id="sidebarCollapse">
          <ul className="navbar-nav">
            <li
              className="nav-item "
              style={{ background: nav.nav === "landing" ? "#302F2F" : "none" }}
            >
              <Link className="nav-link p-5" to="/dashboard">
                <AiFillDashboard className="me-2" size={"1.5rem"} /> Landing
              </Link>
            </li>
            <li
              className="nav-item "
              style={{ background: nav.nav === "products" ? "#302F2F" : "none" }}
            >
            ...
            <li
              className="nav-item "
              style={{ background: nav.nav === "users" ? "#302F2F" : "none" }}
            >
            ...
            <li
              className="nav-item "
              style={{ background: nav.nav === "orders" ? "#302F2F" : "none" }}
            >
